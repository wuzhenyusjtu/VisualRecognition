...
tf.app.flags.DEFINE_string('image_dir', '/home/zhenyu/Desktop/raw_images/raw_images_grey/images_train',
...
def main(_):
	...
	for i in range(FLAGS.how_many_training_steps):
		...
		if (i % FLAGS.eval_step_interval) == 0 or is_last_step:
			...
			print('%s: Step %d: Train accuracy = %.1f%%' % (datetime.now(), i,
																											train_accuracy * 100))
			output_f.write('%s: Step %d: Train accuracy = %.1f%%' % (datetime.now(), i,
																											train_accuracy * 100) + '\n')

			print('%s: Step %d: Cross entropy = %f' % (datetime.now(), i,
																								 cross_entropy_value))
			output_f.write('%s: Step %d: Cross entropy = %f' % (datetime.now(), i,
																								 cross_entropy_value) + '\n')
			...
			output_f.write('%s: Step %d: Validation accuracy = %.1f%%' %
						(datetime.now(), i, validation_accuracy * 100) + '\n')
	...
	output_f.write('Final test accuracy = %.1f%%' % (test_accuracy * 100) + '\n')
